...
(function() {
	...
	var Events = Backbone.Events = {
		...
		// An inversion-of-control version of `on`. Tell *this* object to listen
		// to
		// an event in another object ... keeping track of what it's listening
		// to.
	...
	_.extend(Collection.prototype, Events, {
		...
		add : function(models, options) {
			...
			for (i = 0, l = models.length; i < l; i++) {
				...
				// Listen to added models' events, and index models for lookup
				// by
				// `id` and by `cid`.
		...
		// collection when they arrive. If `update: true` is passed, the
		// response
	...
	var methods = [ 'forEach', 'each', 'map', 'collect', 'reduce', 'foldl', 'inject', 'reduceRight', 'foldr', 'find', 'detect', 'filter', 'select', 'reject', 'every', 'all',
			'some', 'any', 'include', 'contains', 'invoke', 'max', 'min', 'toArray', 'size', 'first', 'head', 'take', 'initial', 'rest', 'tail', 'drop', 'last', 'without',
